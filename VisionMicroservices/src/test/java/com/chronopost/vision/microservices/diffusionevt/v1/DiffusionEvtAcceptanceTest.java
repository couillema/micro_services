...
public class DiffusionEvtAcceptanceTest extends JerseyTestNg.ContainerPerClassTest  {

	private DiffusionEvtResource resourceDiffusionEvtTest=null;
	private ObjectMapper mapper = new ObjectMapper();
	private ITibcoEmsSender mockEms;		
	...
	protected Application configure(){
		mockEms = Mockito.mock(ITibcoEmsSender.class);
		...
		resourceDiffusionEvtTest.setService(DiffusionEvtServiceImpl.getInstance());
