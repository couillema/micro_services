...
import static com.chronopost.vision.microservices.TestUtils.CREATE_KEYSPACE_SIMPLE_FORMAT;
import static com.chronopost.vision.microservices.TestUtils.SIMPLE_KEYSPACE;
...
public class CCMBridge {
    ...
    static {
        ...
        String ipPrefix = System.getProperty("ipprefix");
