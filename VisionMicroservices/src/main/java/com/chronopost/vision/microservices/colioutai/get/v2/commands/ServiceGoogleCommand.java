...
public class ServiceGoogleCommand extends HystrixCommand<Position> {
	...
	public ServiceGoogleCommand(final GoogleGeocoderHelper googleGeocoderHelper, final GeoAdresse adresse) {
	...
	protected Position run() throws Exception {
		...
		final Position position = FeatureFlips.INSTANCE.getBoolean("Geocodage_Colioutai_Gmaps_Actif", true)?googleGeocoderHelper.geocodeFrom(adresse):null;
