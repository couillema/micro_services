...
public class TraitementConsigneCommand extends HystrixCommand<Boolean> {

    private final static org.slf4j.Logger logger = LoggerFactory.getLogger(TraitementConsigneCommand.class);

    private List<EvtEtModifs> evenements;

    public TraitementConsigneCommand(List<EvtEtModifs> pEvenements) {
    ...
    protected Boolean run() throws Exception {
        return UpdateSpecificationsColisServiceImpl.getInstance().traitementConsigne(evenements) ;
    }
